...
falling motly along the diagonal line with some deviation at the extreme
ends which are not sufficient to violate the assumption of normality,
therefore we may assume that the residuals are normally distributed.
Finally, the residuals versus factor plot indicates no significant
outliers, validating the assumption of absence of influential outliers.
