...
-   *What improvements did they suggest, and do you agree?*
    ...
    1) Make more use of functions, for example in creating the results
    table a function could have been used to form the male and female
    rows. I agree with this
