...
Cleaning the raw data and saving cleaned version 
```{r}
#clean data
...
# Create a scatterplot that is poorly made
ggplot(species_flipper_length_and_bodymass, aes(x = flipper_length_mm, y = body_mass_g, color = species)) +
  ...
  labs(title = "Flipper Length vs Body Mass", 
       ...
       y = "Body Mass (g)") +
  theme_minimal() +
  theme(axis.text = element_text(size = 30, angle = 90, color = "blue"),
        legend.position = "top") +  # Overly large axis text with awkward orientation
  scale_color_manual(values = c("hotpink", "yellow", "limegreen")) +  # Clashing colors
  coord_cartesian(xlim = c(150, 250), ylim = c(2000, 7000))  # Restricting data view unnecessarily
